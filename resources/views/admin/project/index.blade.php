        ...
        <div class="col-xs-12">
            ...
            <div class="box box-success">
                ...
                <div class="box-header with-border">
                    ...
                    @if(App\Model\Permission::roleHasSpecificPermission('project.create'))

                    <div class="box-tools pull-right">
                        <a href="{{route('project.create')}}" class="btn btn-xs btn-success pull-left text-white" title="Add New"><i class="fa fa-plus"></i> <span class="text-capitalize">Add Project</span></a>
                    </div>
                    @endif
                </div>
                    ...
                    <table class="table table-bordered table-hover table-striped list-data">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(!empty($data->image))
                                    <img class="profile-user-img img-responsive img-circle" src="{{ asset('storage/images/'.$data->image) }}" style="width: 100px; height: 100px;" /></td>
                                    @else
                                ...
                                <td>
                                    ...
                                    @if(App\Model\Permission::roleHasSpecificPermission('project.show'))

                                    <a href="{{route('project.show', $data->id)}}" class="btn btn-xs btn-success action-view" title="View"><i class="fa fa-eye"></i></a>

                                    @endif

                                    @if(App\Model\Permission::roleHasSpecificPermission('project.edit'))

                                    <a href="{{route('project.edit', $data->id)}}" class="btn btn-xs btn-primary action-pencil" title="Edit"><i class="fa fa-pencil"></i></a>

                                    @endif

                                    @if(App\Model\Permission::roleHasSpecificPermission('project.destroy'))
