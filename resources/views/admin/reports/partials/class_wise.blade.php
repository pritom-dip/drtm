<table class="table table-bordered table-hover table-striped list-data">
    ...
    <tbody>
        ...
        <th><strong>{{number_format($fullAmount,2)}}</strong></th>
    </tbody>
    <tbody>
        <th></th>
        <th></th>
        ...
        <th></th>
        <th></th>
        <th><strong>Total Collection</strong></th>
        <th><strong>{{number_format($classWise->sum('amount'), 2)}}</strong></th>
    </tbody>
    <tbody>
        <th></th>
        <th></th>
        ...
        <th><strong>{{number_format(($fullAmount - $classWise->sum('amount')),2)}}</strong></th>
    </tbody>
